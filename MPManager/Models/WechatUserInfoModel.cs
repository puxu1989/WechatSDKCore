...
namespace WechatSDKCore.MPManager.Models
{
    ...
    {
        public string openId { get; set; }  //新版解密没有了
        public string unionId { get; set; }// 新版没有了 小程序必须绑定在微信开放平台上，不绑定是没有的unionId（PS：绑定开放平台需要开发者资质认证，认证收费的奥）
        ...
        public int gender { get; set; }  //性别  省市县已经下线了  2021年10月份后获取不到了
